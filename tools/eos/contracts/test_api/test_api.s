...
.LBB126_8:
	...
	i32.const	$push22=, 16
	i32.call	$push134=, _Znwj@FUNCTION, $pop22
	tee_local	$push133=, $2=, $pop134
	i32.const	$push23=, 8
	i32.add 	$push24=, $pop133, $pop23
	...
	i32.add 	$push31=, $pop75, $pop129
	i32.const	$push32=, 0
	i32.store	0($pop31), $pop32
	i32.const	$push33=, 48
	i32.add 	$push34=, $7, $pop33
	i32.const	$push128=, 0
	i32.store	0($pop34), $pop128
	i32.const	$push127=, 0
	i32.store	28($7), $pop127
	i32.const	$push126=, 0
	i32.store8	32($7), $pop126
	i32.const	$push125=, 0
	i32.store	36($7), $pop125
	i32.const	$push124=, 0
	i32.store	40($7), $pop124
	...
	i32.const	$push123=, 0
	i32.store	52($7), $pop123
	i32.const	$push40=, 56
	i32.add 	$push41=, $7, $pop40
	i32.const	$push122=, 0
	i32.store	0($pop41), $pop122
	i32.const	$push42=, 60
	i32.add 	$push43=, $7, $pop42
	i32.const	$push121=, 0
	i32.store	0($pop43), $pop121
	i32.const	$push120=, 0
	i32.store	64($7), $pop120
	i32.const	$push44=, 68
	i32.add 	$push45=, $7, $pop44
	i32.const	$push119=, 0
	i32.store	0($pop45), $pop119
	i32.const	$push46=, 72
	i32.add 	$push47=, $7, $pop46
	i32.const	$push118=, 0
	i32.store	0($pop47), $pop118
	i32.const	$push48=, 52
...
.LBB126_11:
	...
	i32.add 	$push56=, $pop85, $pop137
	i32.load	$push136=, 0($pop56)
	tee_local	$push135=, $2=, $pop136
	i32.eqz 	$push141=, $pop135
	br_if   	0, $pop141
...
.LBB126_13:
	...
	i32.const	$push59=, 96
	i32.add 	$push60=, $7, $pop59
	i32.load	$push139=, 0($pop60)
	tee_local	$push138=, $2=, $pop139
	i32.eqz 	$push142=, $pop138
	br_if   	0, $pop142
...
.LBB190_19:
	...
	.endfunc
.Lfunc_end190:
	.size	memccpy, .Lfunc_end190-memccpy
